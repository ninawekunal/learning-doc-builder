    ...
    <HashRouter>
      ...
      <Layout bionic={bionic} onToggleBionic={toggleBionic}>
        <Routes>
          ...
          />
          <Route path="/docs/:slug" element={<EntryPage kind="doc" bionic={bionic} />} />
          <Route
            path="/blog"
            element={<ListPage title="Blog" blurb="Shorter pieces, same reading controls." entries={posts} />}
          />
          <Route path="/blog/:slug" element={<EntryPage kind="blog" bionic={bionic} />} />
          <Route path="/how-it-works" element={<HowItWorks bionic={bionic} />} />
